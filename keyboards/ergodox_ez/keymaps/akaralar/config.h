...
#define SERIAL_NUMBER "0Nz7P/bv0Dqp"
...
#define DUMMY_MOD_NEUTRALIZER_KEYCODE KC_RIGHT_ALT
#define MODS_TO_NEUTRALIZE { MOD_BIT(KC_LEFT_ALT), MOD_BIT(KC_LEFT_GUI), MOD_BIT(KC_RIGHT_GUI), MOD_BIT(KC_LEFT_SHIFT), MOD_BIT(KC_RIGHT_SHIFT), MOD_BIT(KC_LEFT_CTRL), MOD_BIT(KC_RIGHT_CTRL) }
